 ...
 * // ru
 * Конструктор матрицы 4
 * Если указан opt_src, новая матрица инициализируется opt_src.
 * В противном случае новая матрица инициализируется идентификационной матрицей.
 * @param opt_src исходная матрица(опция)
 */
